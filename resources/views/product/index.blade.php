        ...
        <tbody>
            <tr>
                ...
                <td class="text-center w-25">
                    <img src="#" alt="Product Image" class="img-fluid w-50">
                </td>
                <td class="text-center">Nama Produk</td>
                <td class="text-center">Rp {{ number_format(10000, 0, ',', '.') }}</td>
                <td class="text-center">50</td>
                <td class="text-center">
                    <div class="d-grid gap-4 d-md-flex justify-content-md-end">
                        <a href="{{ route('product.edit') }}"><button type="button" class="btn btn-warning">Edit</button></a>
                        <button class="btn btn-primary btn-update-stock" data-bs-toggle="modal"
                            data-bs-target="#updateStockModal" data-id="1"
                            data-name="Nama Produk" data-stock="50">
                            Update Stok
                        </button>
